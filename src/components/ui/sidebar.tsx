...
function SidebarHeader({className, ...props}: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 bg-[#0A6F6F] color-white font-bold text-white", className)}
      {...props}
    >
      <h1 className={"p-3 text-xl font-bold"}>Student Hunt</h1>
    </div>
  )
}
...
function SidebarFooter({className}: React.ComponentProps<"div">) {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      fetch("http://studenthuntback-production.up.railway.app/api/profile", {
        headers: {
...
function SidebarContent({className, children, ...props}: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-[#0A6F6F] text-white flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    >
